   ...
   public class WriterValidator: AbstractValidator<Writer>
    {
        public WriterValidator() {
                ...
                RuleFor(x => x.WriterTitle).NotEmpty().WithMessage("Üvan kısmını  Boş geçemezsiniz");
                RuleFor(x => x.WriterSurName).MinimumLength(2).WithMessage("Lütfen en az 3 karakter giriniz");
